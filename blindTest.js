...
class BlindTest extends HTMLElement{
    ...
    setUpNext(){
        ...
        document.getElementById('countdownSVG-div').style.display='flex'
        ...
        <div class="bt-container" id="bt-container">
            <div class="bt-solo">
                <div class='bt-container-part1'>
                    ...
                    <div style="display:flex;width:calc(100% - 30px);margin-top:16px;position:relative;justify-content:right;">
                ...
                <div class="bt-container-box">
                    <div class='bt-container-part2'>
                        ...
                        <div id="countdownSVG-div" style="height:100%;width:fit-content;align-self:center;display:flex;justify-content:center;align-items:center;">
